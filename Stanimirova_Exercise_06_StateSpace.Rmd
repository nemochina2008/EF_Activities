...
FIX the confidence interval in the case of y.monthly - wider!!


```{r}

out.monthly <- as.matrix(jags.out.monthly)
ci.monthly <- apply(exp(out[,3:ncol(out.monthly)]),2,quantile,c(0.025,0.5,0.975))
...
ci.rm40 <- apply(exp(out[,3:ncol(out.rm40)]),2,quantile,c(0.025,0.5,0.975))
